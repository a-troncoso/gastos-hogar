import { CATEGORY_QUERIES } from "./category.constants";
import { database } from "../../shared";

const dbName = "db.GastosHogar";
const connDB = database.connectedDB({ engine: "sqlite", name: dbName });

const useCategoryLocalDB = ({ operation }) => {
  ...
  return apiByOperation[operation];
};

export default useCategoryLocalDB;
